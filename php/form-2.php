...
{
	$to = 'marrow@ukr.net';
	$subject = 'Заказ с сайта Amazingwebstudio';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Email:</b></td><td>' . htmlentities($_REQUEST["email1"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Телефон:</b></td><td>' . htmlentities($_REQUEST["message1"],ENT_COMPAT,'UTF-8') . '</td></tr>';
